...
Owner_Of_Circle INTEGER, 
Type VARCHAR(50), 
PRIMARY KEY(Circle_Id), 
FOREIGN KEY (Owner_Of_Circle) REFERENCES User(User_Id), 
CHECK (Circle_Id > 0) 
); 
...
Author INTEGER, 
PRIMARY KEY (Post_Id), 
FOREIGN KEY (Circle) REFERENCES Circle(Circle_Id),
...
FOREIGN KEY (Advertisement) REFERENCES Advertisement(Advertisement_Id), 
FOREIGN KEY (User,Account) REFERENCES User_Has_Account(User_Id, Account_Number) 
);
